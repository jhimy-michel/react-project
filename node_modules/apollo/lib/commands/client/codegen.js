...
class Generate extends Command_1.ClientCommand {
    async run() {
        const { flags: { watch, queries } } = this.parse(Generate);
        ...
        if (watch) {
            await run().catch(() => { });
            const watcher = new gaze_1.Gaze(queries);
...
Generate.flags = Object.assign({}, Command_1.ClientCommand.flags, { queries: command_1.flags.string({
