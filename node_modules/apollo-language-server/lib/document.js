...
function extractGraphQLDocuments(document) {
...
function extractGraphQLDocumentsFromJSTemplateLiterals(document) {
...
function extractGraphQLDocumentsFromPythonStrings(document) {
    const text = document.getText();
    const documents = [];
